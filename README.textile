...
bq. by Ben Burkert
bq. forked by Anders Åslund to make windows support
...
* none!
edit:
   now it has no requirements and supports Windows
...
for this forked version:
   ...
   Let bundler doit for you:
   add it to your gemfile gem 'randexp', :git => "https://github.com/aadlww/randexp.git"
